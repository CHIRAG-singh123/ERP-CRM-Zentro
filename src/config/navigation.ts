...
const baseNavigation: AppNavigationSection[] = [
  {
    ...
    items: [
      ...
      { label: 'Leads', href: '/leads', icon: Users2, roles: ['admin', 'user', 'sales', 'support'] },
      { label: 'Deals', href: '/deals', icon: Handshake, roles: ['admin', 'user', 'sales', 'support'] },
      { label: 'Calendar', href: '/calendar', icon: CalendarClock, roles: ['admin', 'user', 'sales', 'support'] },
      { label: 'Chat', href: '/chat', icon: MessageCircle, roles: ['admin', 'employee'] },
      { label: 'Documents', href: '/documents', icon: FileStack, roles: ['admin', 'user', 'sales', 'support'] },
